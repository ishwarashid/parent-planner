...
<head>
    ...
    <title><?php echo e(config('app.name', 'Parent Planner')); ?></title>
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if(Route::has('login')): ?>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('pricing')); ?>" class="font-medium text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Pricing</a>
        ...
        <main class="flex-grow">
            ...
            <section class="relative bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-20 md:py-32 flex items-center justify-center min-h-[60vh]">
                ...
                <div class="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="bg-white text-indigo-600 hover:bg-indigo-50 transition duration-150 ease-in-out px-8 py-3 rounded-md text-lg font-semibold shadow-lg">
                            Get Started
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-indigo-600 transition duration-150 ease-in-out px-8 py-3 rounded-md text-lg font-semibold shadow-lg">
                            Learn More
                        </a>
                    </div>
                </div>
            ...
            <section class="bg-indigo-700 text-white py-16">
                <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-indigo-700 hover:bg-indigo-100 transition duration-150 ease-in-out px-8 py-3 rounded-md text-lg font-semibold shadow-lg">
                        Sign Up Now
                    </a>
                </div>
            </section>
...
</html><?php /**PATH C:\laragon\www\parent-planner-v2\resources\views/landing.blade.php ENDPATH**/ ?>