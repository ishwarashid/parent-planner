                ...
                <div class="p-6 text-gray-900">
                    <div class="flex items-center mb-4">
                        @if ($child->profile_photo)
                            <img src="{{ asset('storage/' . $child->profile_photo) }}" alt="{{ $child->name }}" class="h-24 w-24 rounded-full object-cover mr-4">
                        @else
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        <dl class="divide-y divide-gray-200">
                            ...
                            <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                <dt class="text-sm font-medium leading-6 text-gray-900">School Info</dt>
                                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $child->school_info ?? 'N/A' }}</dd>
                            </div>
                            <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
