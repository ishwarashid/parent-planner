                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('children.update', $child) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="gender" class="block mt-1 w-full" type="text" name="gender" :value="old('gender', $child->gender)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="blood_type" class="block mt-1 w-full" type="text" name="blood_type" :value="old('blood_type', $child->blood_type)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="allergies" class="block mt-1 w-full" name="allergies" required>{{ old('allergies', $child->allergies) }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="primary_residence" class="block mt-1 w-full" type="text" name="primary_residence" :value="old('primary_residence', $child->primary_residence)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="school_name" class="block mt-1 w-full" type="text" name="school_name" :value="old('school_name', $child->school_name)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="school_grade" class="block mt-1 w-full" type="text" name="school_grade" :value="old('school_grade', $child->school_grade)" />
                        ...
                        <div class="mt-4">
                            ...
                            @if ($child->profile_photo_path)
                                <div class="mt-2 mb-2">
                                    <img src="{{ asset('storage/' . $child->profile_photo_path) }}" alt="Current Profile Photo" class="h-20 w-20 rounded-full object-cover">
                                </div>
                            @endif
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="extracurricular_activities" class="block mt-1 w-full" name="extracurricular_activities">{{ old('extracurricular_activities', $child->extracurricular_activities) }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="doctor_info" class="block mt-1 w-full" name="doctor_info">{{ old('doctor_info', $child->doctor_info) }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="emergency_contact_info" class="block mt-1 w-full" name="emergency_contact_info">{{ old('emergency_contact_info', $child->emergency_contact_info) }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="special_needs" class="block mt-1 w-full" name="special_needs">{{ old('special_needs', $child->special_needs) }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="other_info" class="block mt-1 w-full" name="other_info">{{ old('other_info', $child->other_info) }}</x-text-area>
