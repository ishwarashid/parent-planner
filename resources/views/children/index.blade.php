                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if ($child->profile_photo)
                                                <img src="{{ asset('storage/' . $child->profile_photo) }}" alt="{{ $child->name }}" class="h-10 w-10 rounded-full object-cover">
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $child->school_info ?? 'N/A' }}</div>
                                        </td>
