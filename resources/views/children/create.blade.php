                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('children.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-area id="allergies" class="block mt-1 w-full" name="allergies">{{ old('allergies') }}</x-text-area>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="school_info" class="block mt-1 w-full" type="text" name="school_info" :value="old('school_info')" />
