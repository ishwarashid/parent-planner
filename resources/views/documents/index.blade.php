                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($documents as $document)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $document->child->name }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">No documents found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
