                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div class="border rounded-lg shadow-lg p-8 flex flex-col">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('checkout', ['plan' => 'price_1RlnbZPOErLRYIriPtbcMUQx']) }}" class="w-full text-center bg-indigo-600 text-white hover:bg-indigo-700 transition duration-150 ease-in-out px-8 py-3 rounded-md text-lg font-semibold shadow-lg">
                                    Subscribe
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg shadow-lg p-8 flex flex-col">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('checkout', ['plan' => 'price_premium']) }}" class="w-full text-center bg-indigo-600 text-white hover:bg-indigo-700 transition duration-150 ease-in-out px-8 py-3 rounded-md text-lg font-semibold shadow-lg">
                                    Subscribe
                                </a>
                            </div>
                        </div>
