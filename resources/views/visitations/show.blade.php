                            ...
                            <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <span
                                        ...
                                        @elseif($visitation->status == 'Cancelled') bg-gray-100 text-gray-800
                                        @elseif($visitation->status == 'Missed') bg-red-100 text-red-800
                                        @elseif($visitation->status == 'Rescheduled') bg-yellow-100 text-yellow-800
                                        @elseif($visitation->status == 'Other') bg-purple-100 text-purple-800 @endif">
                                        {{ $visitation->status }}
                                    </span>
                                    @if($visitation->status == 'Other' && $visitation->custom_status_description)
                                        <div class="mt-2 text-sm text-gray-600">
                                            <strong>Custom Description:</strong> {{ $visitation->custom_status_description }}
                                        </div>
                                    @endif
                                </dd>
                            </div>
