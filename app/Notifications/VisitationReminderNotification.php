...
class VisitationReminderNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Upcoming Visitation Reminder for ' . $childName)
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('This is a reminder for an upcoming visitation:')
