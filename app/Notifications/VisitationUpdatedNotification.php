...
class VisitationUpdatedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Visitation Updated: ' . $childName)
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('A visitation has been updated:')
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'updated_at' => $this->visitation->updated_at,
        ];
    }
}